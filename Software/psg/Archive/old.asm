...
PSG_WRITE = %00100000					; BDIR High, BC1 Low
PSG_ADDR = %00100001					; BDIR High, BC1 High
...
next:
				...
				jp nz, loop				; Repeat if not arrived at last address
...
PSGCommands:
				DB $DE							; R0, Port A fine adjustment = $DE
				DB $01							; R1, Port A coarse adjustment = $01
				DB $DE							; R2, Clear
				DB $01							; R3, Clear
				DB $DE							; R4, Clear
				DB $01							; R5, Clear
				DB $00							; R6, Clear
				DB $F8							; R7, Tone Enable on Channel A, Noise Disable, Input Disable
